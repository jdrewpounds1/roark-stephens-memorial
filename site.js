(function(){
  ...
  if(ticker){
    const items = `
      ...
      <a class="supporter-partner" href="https://www.acraprintingandsignsvillarica.com/" target="_blank" rel="noopener noreferrer" aria-label="Visit ACRA Printing and Signs"><img src="sponsor-acra-mark.png" alt="ACRA Printing and Signs logo" width="40" height="40"><span>ACRA Printing &amp; Signs</span></a>
    ...
    if(!document.getElementById('supporterTickerUpgradeStyles')){
      ...
      style.textContent = `
        ...
        .supporter-ticker-label{flex:0 0 220px;width:220px;display:flex;align-items:center;justify-content:center;gap:6px;padding:0 5px;background:#0d3528;color:#f0c65e;font-family:'Allura',cursive;font-weight:400;font-size:17px;line-height:1;white-space:nowrap;overflow:hidden;text-align:center;z-index:2;box-shadow:8px 0 24px rgba(0,0,0,.18)}
        .supporter-ticker-label img{width:26px;height:32px;object-fit:contain;flex:0 0 auto}

  ...
  if(ticker){
    ...
    if(!document.getElementById('supporterTickerUpgradeStyles')){
      ...
      style.textContent = `
        ...
        .supporter-ticker-label{flex:0 0 220px;width:220px;display:flex;align-items:center;justify-content:center;gap:8px;padding:0 8px;background:#0d3528;color:#f0c65e;font-family:'Allura',cursive;font-weight:400;font-size:19px;line-height:1;white-space:nowrap;text-align:center;z-index:2;box-shadow:8px 0 24px rgba(0,0,0,.18)}
        .supporter-ticker-label img{width:28px;height:34px;object-fit:contain}
